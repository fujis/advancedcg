...
class WaveSWE
{
	...
	// 浮遊物
	rxPolygons m_sphere;			//!< 球体メッシュ
	glm::vec3 m_sphere_cen, m_sphere_vel;
	float m_sphere_rad;
...
public:
	...
	// 球体のシーンへの追加
	void AddSphere(const glm::vec3 c, const float r){ m_sphere_cen = c; m_sphere_rad = r; m_sphere_vel = glm::vec3(0.0f); }
...
protected:
	...
	void couplingRigid(float *d, float dt);
